...
1. Variáveis Psicológicas, que são os objetivos e intenções do usuário.
2. Variáveis Físicas (estados do sistema) e Controles Físicos (mecanismos de interação).
